There are four fundamental stages, or processes, 
in the creation of any C program:
editing;
compiling;
linking;
executing;
...
if you omit the -c flag, your program
will automatically be linked as well.
...
a string of characters between double quotes like this is called a string
literal.
